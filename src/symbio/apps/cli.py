...
def build_parser() -> argparse.ArgumentParser:
    ...
    generate.add_argument("--model", "--model-dir", dest="model_dir", default="runs/model")
...
def cmd_generate(args: argparse.Namespace, config: SymbioConfig) -> None:
    ...
    for _ in range(args.n_candidates):
        ...
        candidates.append(detokenize(out_tokens))
    ...
    if args.log:
        ...
        entry = {
            ...
            "ranked": [
                {"total": r.total, "scores": r.scores, "text": r.text} for r in ranked
            ],
        }
